...
<div className="w-[22%] shadow-md mt-10 border border-slate-50 rounded-lg m-auto">
            <div className=" w-[90%] m-auto ">
                ...
                <div className="grid justify-items-center mt-5 text-blue-500 font-semibold text-xl ">Log in</div>
                ...
                <div className="grid  justify-items-end mt-2 font-thin text-gray-600 ">Forgot password</div>
                <div className="grid  justify-items-center mt-5">  <button className =
            "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4  focus:outline-none focus:ring-blue-300  rounded ml-2 text-sm px-10  py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button> </div>
                ...
                <div className="text-center text-gray-600  mt-10 mb-6"><span className="font-thin">New User?</span><span className="text-blue-500 font-normal"><Link href="/signup"> Signup here</Link></span></div>
